...
prod_root="${BARKAN_WEB_PROD_DIR:-${AIDENTITY_WEB_PROD_DIR:-/var/www/barkan-web}}"
releases_dir="$prod_root/releases"
current_link="$prod_root/current"
api_health_url="${BARKAN_API_HEALTH_URL:-${AIDENTITY_API_HEALTH_URL:-http://127.0.0.1:4000/api/health}}"
api_health_retries="${BARKAN_API_HEALTH_RETRIES:-${AIDENTITY_API_HEALTH_RETRIES:-20}}"
api_restart_cmd="${BARKAN_API_RESTART_CMD:-${AIDENTITY_API_RESTART_CMD:-}}"
prod_pm2_api_name="${BARKAN_PROD_PM2_API_NAME:-${AIDENTITY_PROD_PM2_API_NAME:-prod-barkan-api}}"
